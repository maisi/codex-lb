...
- [x] 1.5 Add account probe logging coverage proving safe outcome logs do not leak tokens.
...
- [x] 2.4 Emit safe application logs for Force probe start, upstream status, rejection, and completion.
