...
- **Ratchet at 119.** The surface is 118 fields today. The four additional,
  default-off account-token-vending settings prevent refresh-token ownership
  collisions between independent instances. The ratchet only goes
...
committing the diff. Adding a 120th setting additionally fails the ratchet
