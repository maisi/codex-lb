                ...
                if not (
                    ...
                    if replay_text is None:
                        ...
                        if request_state.prompt_cache_continuation_attempted:
                            ...
                            if request_state.replay_required_account_id is None:
                                # Only an account-neutral resend is genuinely
                                # unpinned; a replay still bound to the anchor's
                                # owner must keep the reroute permission withheld.
