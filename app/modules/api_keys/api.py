...
def _to_response(row: ApiKeyData) -> ApiKeyResponse:
    return ApiKeyResponse(
        ...
        force_include_usage=row.force_include_usage,
        prompt_cache_affinity_continuation=row.prompt_cache_affinity_continuation,
...
async def update_api_key(
    ...
    update = ApiKeyUpdateData(
        ...
        force_include_usage=payload.force_include_usage,
        force_include_usage_set="force_include_usage" in fields,
        prompt_cache_affinity_continuation=payload.prompt_cache_affinity_continuation,
        prompt_cache_affinity_continuation_set="prompt_cache_affinity_continuation" in fields,
        enforced_model=payload.enforced_model,
