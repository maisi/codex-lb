...
def test_prometheus_metrics_defined_when_dependency_available(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert prometheus_module.prompt_cache_continuation_total.name == "codex_lb_prompt_cache_continuation_total"
    assert prometheus_module.prompt_cache_continuation_total.labelnames == ("outcome", "reason")
